...
Тож завантаження програмного модуля **`sentiment-analyser`** забезпечується введенням в командному рядку повного імені завантажувальної програми з додатковими параметроми - текстом інформаційного повідомлення <text>, яке необхідно опрацювати; та мовою інформаційного повідомлення <lang>:
```sh
